...
from hh_utils.hh_simulator import HHSimulator
from experiment_utils.utils import sample_posterior_potential
...
class LGM(GM):
    """Gaussian Lineaer Model (LGM) for testing Simulation Based Inference (SBI).
    ...
    def model_parameters(
        lgm, theta: Tensor, xdims2keep: List[int] = [0, 1, 2, 3], sigma_sq: float = 0.1
